        ...
        <div class="dropdown mb-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" aria-labelledby="navbarDropdownMenuLang">
             @foreach(localization()->getSupportedLocales() as $localeCode => $properties)
                  <li>
                      <a class="dropdown-item" href="{{ route('admin.pages.translations.create', ["page_id" => $page_id, "locale" => $properties->key()]) }}">
                                ...
                                @foreach ($page_translations as $page_translation)
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-25">
                                            ...
                                            <a href="{{ route('admin.pages.translations.edit', $page_translation->id) }}" class="btn btn-primary" title="{{ __('Edit') }}"><i class="fas fa-edit icon"></i> {{ __('Edit') }}</a>
