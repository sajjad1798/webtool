<div>
      ...
      <form wire:submit.prevent="onDaysCalculator">
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onDaysCalculator">
                  <x-loading />
                </div>
        ...
        @if ( !empty($data) )
              <div class="table-responsive mt-3" v-if="this.data">
                <table class="table table-bordered table-hover">
                  <tbody>
                    <tr>
                      <td class="fw-bold bg-light">{{ __('Number of days between two dates:') }}</td>
                      <td class="w-50">{{ $data['days'] }} {{ __('day(s)') }}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
