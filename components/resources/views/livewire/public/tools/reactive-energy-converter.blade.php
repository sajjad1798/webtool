      ...
      <form wire:submit.prevent="onReactiveEnergyConverter">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model.defer="convert_from" class="form-control form-select">
                <option value="volt">{{ __('Volt-Ampere Reactive-hour (VARh)') }}</option>
                <option value="millivolt">{{ __('Millivolt-Ampere Reactive-hour (mVARh)') }}</option>
                <option value="kilovolt">{{ __('Kilovolt-Ampere Reactive-hour (kVARh)') }}</option>
                <option value="megavolt">{{ __('Megavolt-Ampere Reactive-hour (MVARh)') }}</option>
                <option value="gigavolt">{{ __('Gigavolt-Ampere Reactive-hour (GVARh)') }}</option>
            </select>
        </div>
