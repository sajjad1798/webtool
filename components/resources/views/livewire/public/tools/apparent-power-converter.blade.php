      ...
      <form wire:submit.prevent="onApparentPowerConverter">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model.defer="convert_from" class="form-control form-select">
                <option value="volt">{{ __('Volt-Ampere (VA)') }}</option>
                <option value="millivolt">{{ __('Millivolt-Ampere (mVA)') }}</option>
                <option value="kilovolt">{{ __('Kilovolt-Ampere (kVA)') }}</option>
                <option value="megavolt">{{ __('Megavolt-Ampere (MVA)') }}</option>
                <option value="gigavolt">{{ __('Gigavolt-Ampere (GVA)') }}</option>
            </select>
        </div>
