      ...
      <form wire:submit.prevent="onTimeConverter">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model.defer="convert_from" class="form-control form-select">
                ...
                <option value="millisecond">{{ __('Millisecond') }}</option>
                <option value="microsecond">{{ __('Microsecond') }}</option>
                <option value="nanosecond">{{ __('Nanosecond') }}</option>
                <option value="picosecond">{{ __('Picosecond') }}</option>
