<div>
          ...
          <div class="form-group text-center">
              <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:click.prevent="onSentenceCase" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onSentenceCase">
                    <x-loading />
                  </div>
                  <span>{{ __('Sentence case') }}</span>
                </span>
              </button>

              <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:click.prevent="onLowerCase" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onLowerCase">
                    <x-loading />
                  </div>
                  <span>{{ __('lower case') }}</span>
                </span>
              </button>

              <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:click.prevent="onUpperCase" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onUpperCase">
                    <x-loading />
                  </div>
                  <span>{{ __('UPPER CASE') }}</span>
                </span>
              </button>

              <button class="btn btn-info w-md-100" wire:click.prevent="onCapitalizedCase" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onCapitalizedCase">
                    <x-loading />
                  </div>
                  <span>{{ __('Capitalized Case') }}</span>
                </span>
              </button>
          </div>
