<div>
      ...
      <form wire:submit.prevent="onJavascriptDeObfuscator">
        ...
        <div class="form-group position-relative mb-3">
            <textarea id="input" class="form-control" wire:model.defer="code" rows="10" placeholder="{{ __('Paste your code here...') }}" required></textarea>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onJavascriptDeObfuscator">
                  <x-loading />
                </div>
                <span>{{ __('DeObfuscate') }}</span>
              </span>
            </button>
          ...
          @if ( !empty($data) )
            <div class="form-group position-relative mt-3">
                <textarea id="result" class="form-control" rows="10">{{ $data['code'] }}</textarea>
