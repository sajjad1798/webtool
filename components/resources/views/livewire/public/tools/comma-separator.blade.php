<div>
      ...
      <form wire:submit.prevent="onCommaSeparator">
       ...
       <div class="form-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="," wire:model.defer="delimiter">
      </div>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onCommaSeparator">
                  <x-loading />
                </div>
