<div>
      ...
      <form wire:submit.prevent="onBinaryToHex">
        ...
        <div class="input-group input-group-flat mb-3">
            <input type="text" id="input" class="form-control" wire:model.defer="binary" placeholder="{{ __('Paste your Binary code here...') }}" required>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onBinaryToHex">
                  <x-loading />
                </div>
