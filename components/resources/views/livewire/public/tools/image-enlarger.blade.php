                        ...
                        <div class="row w-100">
                            <div class="col">
                                <div class="input-group input-group-flat">
                                    <input id="remote_url" type="text" class="form-control" wire:model.defer="remote_url" placeholder="https://..." {{ $convertType == 'remoteURL' ? 'required' : '' }}>
            ...
            <div class="col-lg-8">
                <fieldset class="form-fieldset d-flex flex-column bd-highlight shadow-sm rotate_image">
                    ...
                    <div class="form-group text-center">
                        <button class="btn btn-info w-md-100" wire:click="onImageEnlarger" wire:loading.attr="disabled">
                          <span>
                            <div wire:loading.inline wire:target="onImageEnlarger">
                              <x-loading />
                            </div>
                            <span>{{ __('Enlarge Image') }}</span>
                          </span>
                        </button>
                    </div>
                </fieldset>
