<div>
      <form wire:submit.prevent="onUtmBuilder">
        ...
        <div>
            ...
            <div class="form-group mb-3">
                <label class="form-label required">{{ __('Website URL') }}</label>
                <input type="text" class="form-control" wire:model.defer="link" required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label required">{{ __('UTM Source') }}</label>
                <input type="text" class="form-control" wire:model.defer="utm_source" required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label required">{{ __('UTM Medium') }}</label>
                <input type="text" class="form-control" wire:model.defer="utm_medium" required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label required">{{ __('UTM Campaign') }}</label>
                <input type="text" class="form-control" wire:model.defer="utm_campaign" required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label required">{{ __('UTM Content') }}</label>
                <input type="text" class="form-control" wire:model.defer="utm_content" required>
            </div>

            <div class="form-group mb-3">
                <label class="form-label required">{{ __('UTM Term') }}</label>
                <input type="text" class="form-control" wire:model.defer="utm_term" required>
            </div>
            ...
            <div class="form-group text-center">
                <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
                    <span>
                        <div wire:loading.inline wire:target="onUtmBuilder">
                            <x-loading />
                        </div>
