<div>
      ...
      <form wire:submit.prevent="onAsciiToBinary">
        ...
        <div class="form-group position-relative mb-3">
            <textarea id="input" class="form-control" wire:model.defer="text" placeholder="{{ __('Paste your content here...') }}" rows="10" required></textarea>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onAsciiToBinary">
                  <x-loading />
                </div>
