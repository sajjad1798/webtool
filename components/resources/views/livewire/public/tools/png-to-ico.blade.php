<div>
      <form wire:submit.prevent="onPngToIco">
        ...
        <div class="image-container mb-3">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_image" accept=".png" {{ $convertType == 'localImage' ? 'required' : '' }}>
                            </div>
                          </div>
          ...
          <div class="form-group text-center">
              <button class="btn btn-info w-md-100" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onPngToIco">
                    <x-loading />
                  </div>
