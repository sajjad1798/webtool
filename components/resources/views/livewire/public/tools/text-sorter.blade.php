<div>
      ...
      <form wire:submit.prevent="onTextSorter">
        ...
        <div class="form-group mb-3">
            <div class="form-label">{{ __('Sorting options') }}</div>
            <div>
                <label class="form-check">
                    <input class="form-check-input" type="radio" wire:model.defer="sorting_options" value="az" name="sorting_options">
                    <span class="form-check-label">{{ __('A-Z') }}</span>
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="radio" wire:model.defer="sorting_options" value="za" name="sorting_options">
                    <span class="form-check-label">{{ __('Z-A') }}</span>
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="radio" wire:model.defer="sorting_options" value="reverse" name="sorting_options">
                    <span class="form-check-label">{{ __('In Reverse order') }}</span>
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="radio" wire:model.defer="sorting_options" value="randomize" name="sorting_options">
                    <span class="form-check-label">{{ __('Randomize') }}</span>
                </label>
                <label class="form-check">
                    <input class="form-check-input" type="checkbox" wire:model.defer="remove_duplicates">
                    <span class="form-check-label">{{ __('Remove all duplicate lines') }}</span>
                </label>
            </div>
        </div>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onTextSorter">
                  <x-loading />
                </div>
                <span>{{ __('Start') }}</span>
              </span>
