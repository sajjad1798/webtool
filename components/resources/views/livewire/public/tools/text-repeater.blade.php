<div>
      ...
      <form wire:submit.prevent="onTextRepeater">
        ...
        <div class="form-group mb-3">
          <label class="form-label">{{ __('Number of repetitions') }}</label>
          <input type="text" class="form-control" wire:model.defer="repetitions" placeholder="12">
       </div>

       <div class="form-group mb-3">
          <label class="form-label">{{ __('Text between repetitions') }}</label>
          <input type="text" class="form-control" placeholder="," wire:model.defer="text_between_repetitions">
      </div>

       <div class="form-group mb-3">
          <label class="form-label">{{ __('Add newline') }}</label>
          <select class="form-control form-select" wire:model.defer="newline">
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onTextRepeater">
                  <x-loading />
                </div>
