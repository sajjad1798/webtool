<div>
      <form wire:submit.prevent="onJpgToIco">
        ...
        <div class="image-container mb-3">
                      ...
                      <div class="row w-100">
                          <div class="col">
                            <div class="form-group">
                              <input type="file" class="form-control" wire:model.defer="local_image" accept=".jpg,jpeg" {{ $convertType == 'localImage' ? 'required' : '' }}>
                            </div>
                          </div>
          ...
          <div class="form-group text-center">
              <button class="btn btn-info w-md-100" wire:loading.attr="disabled">
                <span>
                  <div wire:loading.inline wire:target="onJpgToIco">
                    <x-loading />
                  </div>
        ...
        @if ( !empty($data) )  
            <div class="text-center mt-3" wire:loading.remove wire:target="onPngToIco">
