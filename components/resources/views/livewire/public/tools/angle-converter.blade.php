      ...
      <form wire:submit.prevent="onAngleConverter">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model.defer="convert_from" class="form-control form-select">
                <option value="radian">{{ __('radian') }}</option>
                ...
                <option value="octant">{{ __('octant') }}</option>
                <option value="sextant">{{ __('sextant') }}</option>
                <option value="quadrant">{{ __('quadrant') }}</option>
                <option value="revolution">{{ __('revolution') }}</option>
                <option value="gon">{{ __('gon') }}</option>
                <option value="mil">{{ __('mil') }}</option>
            </select>
        </div>
