      ...
      <form wire:submit.prevent="onDigitalConverter">
        ...
        <div class="form-group mb-3">
            ...
            <select wire:model.defer="convert_from" class="form-control form-select">
                <option value="bit">{{ __('Bit') }}</option>
                <option value="byte">{{ __('Byte') }}</option>
                <option value="kilobyte">{{ __('Kilobyte') }}</option>
                <option value="megabyte">{{ __('Megabyte') }}</option>
                <option value="gigabyte">{{ __('Gigabyte') }}</option>
                <option value="terabyte">{{ __('Terabyte') }}</option>
                <option value="petabyte">{{ __('Petabyte') }}</option>
                <option value="exabyte">{{ __('Exabyte') }}</option>
                <option value="zettabyte">{{ __('Zettabyte') }}</option>
                <option value="yottabyte">{{ __('Yottabyte') }}</option>
            </select>
        </div>
