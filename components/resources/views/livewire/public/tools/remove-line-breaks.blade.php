<div>
      ...
      <form wire:submit.prevent="onRemoveLineBreaks">
        ...
        <div class="form-group mb-3">
            <label class="form-check">
                <input class="form-check-input" type="radio" wire:model="para_option" value="no_paragraphs" />
                <span class="form-check-label">{{ __('Remove line breaks only') }}</span>
            </label>
            <label class="form-check">
                <input class="form-check-input" type="radio" wire:model="para_option" value="paragraphs" />
                <span class="form-check-label">{{ __('Remove line breaks and paragraph breaks') }}</span>
            </label>
        </div>
        ...
        <div class="form-group text-center">
            <button class="btn btn-info w-md-100 mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onRemoveLineBreaks">
                  <x-loading />
                </div>
                <span>{{ __('Format') }}</span>
              </span>
