<div class="text-center">
    ...
    <p>{{ __('Please come back and') }}<a class="text-primary" href="https://codecanyon.net/item/sumowebtools-online-web-tools-script/reviews/34704474"> {{ __('leave a 5-star rating') }} </a>{{ __('if you are happy with this script.') }}</p>
    <div class="row">
        <div class="col-md-12">
          <a href="{{ route('home') }}" class="btn btn-primary my-3">{{ __('View your website!') }}</a>
      </div>
    </div>
