    <header class="navbar navbar-expand-lg navbar-light d-print-none @if ($header->sticky_header)z-index-sticky sticky-top @endif">
                          ...
                          @endphp
                            ...
                            <li class="nav-item dropdown lang-menu">
                                <a class="nav-link dropdown-toggle cursor-pointer" data-bs-toggle="dropdown" href="#navbar-base" aria-label="{{ __('Open language menu') }}">
                                    <img src="{{ asset('assets/img/flags/' . localization()->getCurrentLocale() . '.svg') }}" width="16" height="10" class="lang-image me-1 my-auto" alt="{{ localization()->getCurrentLocaleNative() }}"> 
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                   @foreach(localization()->getSupportedLocales() as $localeCode => $properties)
                                      <a class="dropdown-item border-radius-md mb-1" rel="alternate" hreflang="{{ $properties->key() }}" href="{{ localization()->getLocalizedURL($properties->key(), null, [], false) }}">
                                        <img src="{{ asset('assets/img/flags/' . $properties->key() . '.svg') }}" alt="{{ $properties->native() }}" width="16" height="10" class="lang-image me-1 my-auto"> {{ $properties->native() }}
                                      </a>
                                   @endforeach
                                </div>
                            </li>
