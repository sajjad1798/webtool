<footer class="footer pt-3 mt-3 pb-0">
 ...
 @if ( $general->social_status == true && count($socials) > 0 )
    <h3 class="text-center mb-3">{{ __('Follow us') }}</h3>
    <div class="social-share text-center">
      <div class="share-icons relative">
          @foreach ($socials as $key => $social)
            <a href="{{ $social['url'] }}" class="btn btn-{{ $social['name'] }} btn-simple rounded social-shadow p-2" aria-label="{{ $social['name'] }}" target="_blank">
