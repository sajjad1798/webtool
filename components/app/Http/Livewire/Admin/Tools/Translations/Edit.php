...
class Edit extends Component
{
    ...
    public function render()
    {
        ...
        //Meta
        $title = __('Edit Tool Translation') . ' ' . env('APP_SEPARATOR') . ' ' . env('APP_NAME');
        SEOMeta::setTitle($title);

        return view('livewire.admin.tools.translations.edit')->layout('layouts.admin', [
            'breadcrumbs' => [
    ...
    /**
     * -------------------------------------------------------------------------------
     *  onEditToolTranslation
     * -------------------------------------------------------------------------------
    **/
    public function onEditToolTranslation()
    {   
