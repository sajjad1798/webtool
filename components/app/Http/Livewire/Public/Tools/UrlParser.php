...
use App\Classes\UrlParserClass;
use DateTime;
...
class UrlParser extends Component
{
    ...
    {
        return view('livewire.public.tools.url-parser');
    }
