...
use App\Classes\CurrentConverterClass;
use DateTime, File;
...
class CurrentConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.current-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onCurrentConverter(){
        ...
        try {
            ...
            $output = new CurrentConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Current Converter';
