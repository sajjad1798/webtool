...
use App\Classes\PaceConverterClass;
use DateTime, File;
...
class PaceConverter extends Component
{
    ...
    public $from_value;
    public $convert_from = 'minute_per_kilometer';
    public $from_name;
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.pace-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onPaceConverter(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Pace Calculator';
