...
use App\Classes\FrequencyConverterClass;
use DateTime, File;
...
class FrequencyConverter extends Component
{
    ...
    public $from_value;
    public $convert_from = 'millihertz';
    public $from_name;
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.frequency-converter');
    }

    /**
     * -------------------------------------------------------------------------------
     *  onFrequencyConverter
     * -------------------------------------------------------------------------------
    **/
    public function onFrequencyConverter(){
        ...
        try {
            ...
            $output = new FrequencyConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Frequency Converter';
