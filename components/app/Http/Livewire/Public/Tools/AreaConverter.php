...
use App\Classes\AreaConverterClass;
use DateTime, File;
...
class AreaConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.area-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onAreaConverter(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Area Calculator';
