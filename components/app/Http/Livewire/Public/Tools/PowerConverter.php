...
use App\Classes\PowerConverterClass;
use DateTime, File;
...
class PowerConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.power-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onPowerConverter(){
        ...
        try {
            ...
            $output = new PowerConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Power Converter';
