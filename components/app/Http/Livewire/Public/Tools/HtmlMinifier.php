...
use App\Classes\HtmlMinifierClass;
use DateTime, File;
...
class HtmlMinifier extends Component
{
    ...
    {
        return view('livewire.public.tools.html-minifier');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onHtmlMinifier(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'HTML Minifier';
