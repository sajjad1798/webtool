...
use App\Classes\CalorieCalculatorClass;
use DateTime;
...
class CalorieCalculator extends Component
{
    ...
    {
        return view('livewire.public.tools.calorie-calculator');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onCalorieCalculator(){
        ...
        try {
            ...
            $output = new CalorieCalculatorClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Calorie Calculator';
