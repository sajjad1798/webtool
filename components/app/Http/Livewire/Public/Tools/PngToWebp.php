...
class PngToWebp extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.public.tools.png-to-webp');
    }
    ...
    **/
    public function getValidationRules()
    {
        $baseValidationRules = $this->convertType === 'remoteURL'
            ...
            : ['local_image' => 'required|mimes:png,jpg,jpeg|file|max:' . (1024 * General::first()->file_size)];
    ...
    public function onPngToWebp(){
        ...
        try {
                ...
                if ( pathinfo($temp_url, PATHINFO_EXTENSION) == 'jpg' || pathinfo($temp_url, PATHINFO_EXTENSION) == 'jpeg' || pathinfo($temp_url, PATHINFO_EXTENSION) == 'png' ) {
                    ...
                    $img = Image::make( $temp_url )->encode('webp');
