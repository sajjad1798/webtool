...
use App\Classes\AngleConverterClass;
use DateTime, File;
...
class AngleConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.angle-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onAngleConverter(){
        ...
        try {
            ...
            $output = new AngleConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Angle Converter';
