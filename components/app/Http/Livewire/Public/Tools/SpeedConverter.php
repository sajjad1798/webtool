...
use App\Classes\SpeedConverterClass;
use DateTime, File;
...
class SpeedConverter extends Component
{
    ...
    public $from_value;
    public $convert_from = 'meter_per_second';
    public $from_name;
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.speed-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onSpeedConverter(){
        ...
        try {
            ...
            $output = new SpeedConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Speed Calculator';
