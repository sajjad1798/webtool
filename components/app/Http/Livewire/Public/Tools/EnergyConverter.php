...
use App\Classes\EnergyConverterClass;
use DateTime, File;
...
class EnergyConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.energy-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onEnergyConverter(){
        ...
        try {
            ...
            $output = new EnergyConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Energy Converter';
