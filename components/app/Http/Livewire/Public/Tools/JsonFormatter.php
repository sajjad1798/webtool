...
class JsonFormatter extends Component
{
    ...
    {
        return view('livewire.public.tools.json-formatter');
    }
    ...
    **/
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onJsonFormatter(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'JSON Formatter';
    ...
    **/
    ...
    {
        $this->dispatchBrowserEvent('onSample', ['json' => '{"firstName":"John","lastName":"Smith","gender":"man","age":30,"address":{"streetAddress":"150","city":"San Diego","state":"CA","postalCode":"263142"}}']);
        $this->data = null;
    }
