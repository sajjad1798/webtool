...
class WebpToPng extends Component
{
    ...
    {
        return view('livewire.public.tools.webp-to-png');
    }
    ...
    public function onWebpToPng(){
        ...
        try {
                ...
                if ( pathinfo( $temp_url, PATHINFO_EXTENSION) == 'webp' ) {
                    ...
                    $img = Image::make( $temp_url )->encode('png');
