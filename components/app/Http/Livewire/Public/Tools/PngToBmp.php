...
class PngToBmp extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.public.tools.png-to-bmp');
    }
    ...
    public function onPngToBmp(){
        ...
        try {
                ...
                if ( pathinfo($temp_url, PATHINFO_EXTENSION) == 'jpg' || pathinfo($temp_url, PATHINFO_EXTENSION) == 'jpeg' || pathinfo($temp_url, PATHINFO_EXTENSION) == 'png' ) {
                    ...
                    $img = Image::make( $temp_url )->encode('bmp');
