...
class JavascriptBeautifier extends Component
{
    ...
    {
        return view('livewire.public.tools.javascript-beautifier');
    }

    /**
     * -------------------------------------------------------------------------------
     *  onJavascriptBeautifier
     * -------------------------------------------------------------------------------
    **/
    ...
    **/
    ...
    {
        $this->code = 'function NewObject(prefix){var count=0;this.SayHello=function(msg){count++;alert(prefix+msg)}this.GetCount=function(){return count}}var obj=new NewObject("Message : ");obj.SayHello("You are welcome.");';
    }
