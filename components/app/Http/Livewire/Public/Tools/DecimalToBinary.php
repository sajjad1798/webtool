...
use App\Classes\DecimalToBinaryClass;
use DateTime, File;
...
class DecimalToBinary extends Component
{
    ...
    {
        return view('livewire.public.tools.decimal-to-binary');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onDecimalToBinary(){
        ...
        try {
            ...
            $output = new DecimalToBinaryClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Decimal to Binary';
