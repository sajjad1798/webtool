...
use App\Classes\LengthConverterClass;
use DateTime, File;
...
class LengthConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.length-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onLengthConverter(){
        ...
        try {
            ...
            $output = new LengthConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Length Calculator';
