...
use App\Classes\VolumeConverterClass;
use DateTime, File;
...
class VolumeConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.volume-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onVolumeConverter(){
        ...
        try {
            ...
            $output = new VolumeConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Volume Converter';
