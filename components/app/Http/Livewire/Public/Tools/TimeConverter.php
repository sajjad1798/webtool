...
use App\Classes\TimeConverterClass;
use DateTime, File;
...
class TimeConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.time-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onTimeConverter(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Time Calculator';
