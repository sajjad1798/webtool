...
use App\Classes\PressureConverterClass;
use DateTime, File;
...
class PressureConverter extends Component
{

    public $from_value;
    public $convert_from = 'pascal';
    public $from_name;
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.pressure-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onPressureConverter(){
        ...
        try {
            ...
            $output = new PressureConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Pressure Calculator';
