...
use App\Classes\PartsPerConverterClass;
use DateTime, File;
...
class PartsPerConverter extends Component
{

    public $from_value;
    public $convert_from = 'ppm';
    public $from_name;
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.parts-per-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onPartsPerConverter(){
        ...
        try {
            ...
            $output = new PartsPerConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Parts Per Calculator';
