...
use App\Classes\TemperatureConverterClass;
use DateTime, File;
...
class TemperatureConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.temperature-converter');
    }

    /**
     * -------------------------------------------------------------------------------
     *  onTemperatureConverter
     * -------------------------------------------------------------------------------
    **/
    public function onTemperatureConverter(){
        ...
        try {
            ...
            $output = new TemperatureConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Temperature Calculator';
