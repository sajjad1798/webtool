...
use App\Classes\AsciiToTextClass;
use DateTime, File;
...
class AsciiToText extends Component
{
    public $text;
    public $data = [];
    public $recaptcha; 
    ...
    {
        return view('livewire.public.tools.ascii-to-text');
    }
    ...
    **/
    public function onAsciiToText(){
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'ASCII to Text';
