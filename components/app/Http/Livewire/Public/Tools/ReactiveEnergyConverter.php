...
use App\Classes\ReactiveEnergyConverterClass;
use DateTime, File;
...
class ReactiveEnergyConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.reactive-energy-converter');
    }

    /**
     * -------------------------------------------------------------------------------
     *  onReactiveEnergyConverter
     * -------------------------------------------------------------------------------
    **/
    public function onReactiveEnergyConverter(){
        ...
        try {
            ...
            $output = new ReactiveEnergyConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Reactive Energy Converter';
