...
use App\Classes\DaysCalculatorClass;
use DateTime, File;
...
class DaysCalculator extends Component
{
    ...
    {
        return view('livewire.public.tools.days-calculator');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onDaysCalculator(){
        ...
        try {
            ...
            $output = new DaysCalculatorClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Days Calculator';
