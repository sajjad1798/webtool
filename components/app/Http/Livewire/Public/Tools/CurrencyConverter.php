...
use App\Classes\CurrencyConverterClass;
use DateTime, File;
...
class CurrencyConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.currency-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onCurrencyConverter(){
        ...
        try {
            ...
            $output = new CurrencyConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Currency Converter';
