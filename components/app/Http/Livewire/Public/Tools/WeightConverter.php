...
use App\Classes\WeightConverterClass;
use DateTime, File;
...
class WeightConverter extends Component
{
    ...
    {
        return view('livewire.public.tools.weight-converter');
    }
     ...
     * -------------------------------------------------------------------------------
    **/
    public function onWeightConverter(){
        ...
        try {
            ...
            $output = new WeightConverterClass();
        ...
        if ( !empty($this->data) ) {
            ...
            $history             = new History;
            $history->tool_name  = 'Weight Calculator';
